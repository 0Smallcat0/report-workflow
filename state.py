...
class QAState(BaseModel):
    ...
    waiver_records: list[dict] = Field(default_factory=list)


class RevisionState(BaseModel):
    revision_mode: Optional[str] = None
    tracked_changes_path: Optional[str] = None
...
class ReportState(BaseModel):
    ...
    def new(cls, user_prompt: str, uploaded_files: list[str], output_dir: str) -> "ReportState":
        ...
        return cls(
            ...
            qa={"factuality_report_path": None, "qa_decision": None, "waiver_records": []},
            revision={"revision_mode": None, "tracked_changes_path": None},
